          ...
          target: [
            {
              ...
              required_fields: ["subject_id", "visit_month", "tau_index", "inflammation_index", "mmse", "covariates"],
            },
          ],
        },
          ...
          steps: [
            {
              ...
              inputs: ["raw cohort table", "biomarker files"],
              outputs: ["analysis_ready_table"],
            },
            {
              step_id: "step_002",
              name: "主效应与中介模型",
              description: "检验炎症指标对 Tau 扩散和认知下降的预测关系。",
              inputs: ["analysis_ready_table"],
              outputs: ["effect estimates", "confidence intervals"],
            },
            {
              step_id: "step_003",
              name: "反向因果与敏感性分析",
              description: "检验 Tau 是否先于炎症变化，并比较不同滞后窗口。",
              inputs: ["longitudinal features"],
              outputs: ["falsification report"],
            },
          ],
        },
        experiments: {
