...
export const artifactItems: ArtifactItem[] = [
  ...
  },
  {
    ...
    kind: "context",
    path: "artifacts/tasks/task_001/task_context.latest.json",
    status: "mocked",
  ...
  ...stageOrder.flatMap((stage) => [
    {
      ...
      kind: "input" as const,
      path: `artifacts/tasks/task_001/inputs/${stage}.input.json`,
      stage,
    ...
    },
    {
      ...
      path: `artifacts/tasks/task_001/outputs/${stage}.output.json`,
      stage,
      status: "mocked" as const,
